                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination mb-0">
                        ...
                        <li class="page-item" :class="backward_button ? 'disabled' : ''">
                            <button class="page-link" aria-label="Previous" :disabled="backward_button" @click="backward">
                                <i class="fas fa-chevron-left"></i>
                            </button>
                        </li>


                        <li class="page-item active" v-for="value in count">
                            <button class="page-link" @click="page(value)">{{ value }}</button>
                        </li>


                        <!-- Кнопка "Вперед" -->
                        <li class="page-item" :class="forward_button ? 'disabled' : ''">
                            <button class="page-link" aria-label="Next" :disabled="forward_button" @click="forward">
