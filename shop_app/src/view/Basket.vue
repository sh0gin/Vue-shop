      ...
      <div class="col-lg-4 mb-4">
        ...
        <!-- <div class="card mt-4">
          <div class="card-header bg-white">
            <p class="card-text">г. Москва, ул. Примерная, д. 123, кв. 45</p>
            <h6 class="mb-0"><i class="fas fa-truck me-2"></i>Адрес доставки</h6>
          </div>
          <div class="card-body">
            <button class="btn btn-outline-primary btn-sm w-100">
              <i class="fas fa-map-marker-alt me-2"></i>Изменить адрес
            </button>
          </div>
        </div> -->
      </div>
...
export default {
  ...
  methods: {
    ...
    async load() {
      ...
      const product = await fetch(`${this.$config.apiUrl}api/basket`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${this.$config.activeToken}`,
