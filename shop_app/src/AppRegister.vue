                ...
                <form @submit.prevent="registation">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                ...
                                <div v-if="firstName_error"><small> {{ this.firstName_error }} </small> </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-floating">
                                ...
                                <div v-if="lastName_error"><small> {{ this.lastName_error }} </small> </div>
                    ...
                    <div class="mb-3">
                        <div class="form-floating">
                            ...
                            <div v-if="email_error"><small> {{ this.email_error }} </small> </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="form-floating">
                            ...
                            <div v-if="password_error"><small> {{ this.password_error }} </small> </div>

                        </div>
                    </div>

                    <button type="submit" class="btn btn-primary w-100 mb-3 btn-register">Зарегистрироваться</button>

                    <div class="login-link text-center mt-3">
                        <p class="text-muted">Уже есть аккаунт? <router-link to="/login">Войти</router-link></p>
                    </div>
                </form>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async registation() {
            ...
            let result = await fetch("http://web3-14-08-25.local/api/register", requestOptions)
